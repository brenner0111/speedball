...
public class GunUtils {
    ...
    public String addPlayerPaintballs(ArrayList<Paintball> paintballs, ArrayList<Bunker> bunkers, Player player, String clientString, int i) {
        for (int j = 0; j < paintballs.size(); j++) {
            if ((paintballs.get(j).getX() > 0 && paintballs.get(j).getX() < 1045)
                ...
                if (!paintballCollided(paintballs.get(j), bunkers, paintballs.get(j).getQuadrant(), player)) {
                    clientString += "pb" + (i + 1) + " ";
    ...
    public boolean paintballCollided(Paintball paintball, ArrayList<Bunker> bunkers, int quadrant, Player player) {
        ...
        for (int i = 0; i < 25; i++) {
            ...
            //Need to loop over players if we ever want to add 2v2 ... 
            ...
            if (playerVert.length != 0 && Intersector.overlapConvexPolygons(paintballVertices, playerVert, null)) {
                paintball.setCollided(true);
                //System.out.println("Player Vert: " + playerVert[0] + " " + playerVert[1] + " " + playerVert[2] + " " + playerVert[3] + " PaintballVert: " + paintballVertices[0] +
                //    " " + paintballVertices[1] + " " + paintballVertices[2] + " " + paintballVertices[3]);
                //System.out.println("HIT");
                //System.out.println("Player hit from paintballCollided");
                player.setHit(true);
                return true;
            }
            else {
